 ...
 * it names the problem and the interface translates it: each code is a key under
 * `app.announcements.validation` in both locales, and `typecheck` is what proves
 * none is missing.
 */
